...
| Functors | Class wrapper to operator ```()``` | Context-dependent | Potential performance issues (if not inlined), state management and type deduction complexity, slicing issues (when returning as a base class object), lifetime management
